...
class AuditAction(str, enum.Enum):
    ...
    WHITELIST_ADDRESS_REMOVED = "WHITELIST_ADDRESS_REMOVED"
    WHITELIST_ADDRESS_USED = "WHITELIST_ADDRESS_USED"

    # Seguridad - Anti-Phishing
    ANTI_PHISHING_CONFIGURED = "ANTI_PHISHING_CONFIGURED"

    # Seguridad - MFA Backup Codes
    ...
    # Seguridad - Dispositivos y Sesiones
    ...
    PASSWORD_HIBP_CHECK = "PASSWORD_HIBP_CHECK"
